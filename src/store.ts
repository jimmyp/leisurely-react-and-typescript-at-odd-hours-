...
export type AppState = { images: Image[], index: number, user?: AppUser };
const images: Image[] = [
...
function reducer(
    ...
    action: RotateImageAction | SetImagesAction | NextImageAction | PrevImageAction | SetAppUserAction | LoadUserAction
): AppState {
    switch (action.type) {
        case 'rotateImage': 
            return { 
